...
#define EXPLOR_DRIVE_TIME_TO_STOPP_BEFORE_EXPLORED_FIELD	(0.09)//time to continue Driving, if next field is explored- -> stop pos should be same as in Stop before wall
